...
const CONFIG = {
  ...
  story: {
    title: "우리의 이야기",
    content: "12개의 스트라이크가 모여 300점이 되듯 \n서로에게 단 하나뿐인 퍼펙트스코어가 되고자 합니다.\n\n같은 레인에서 시작해 같은 인생을 걷기로 한 저희의 첫 투구를 지켜봐주세요."
  },
  ...
  accounts: {
    groom: [
      ...
      { role: "아버지", name: "허윤선", bank: "기업은행", number: "505-066-987-01-012" },
      { role: "어머니", name: "임성옥", bank: "기업은행", number: "505-066-987-01-012" }
    ],
    bride: [
      { role: "신부", name: "최인비", bank: "카카오뱅크", number: "3333-13-8415678" },
      { role: "아버지", name: "최장헌", bank: "우리은행", number: "505-066-987-01-012" }
    ]
  },
