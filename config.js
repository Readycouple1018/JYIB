...
const CONFIG = {
  ...
  wedding: {
    ...
    venue: "아이티컨벤션",
    hall: "그레이스홀",
    address: "경기도 용신시 기흥구 흥덕1로 13 (영덕동 1005) 흥덕IT밸리 A동 (Tower) 2층",
    tel: "031-255-7000",
    mapLinks: {
  ...
  accounts: {
    ...
    bride: [
      ...
      { role: "아버지", name: "최장헌", bank: "기업은행", number: "000-000-000000" },
      { role: "어머니", name: "한진숙", bank: "농협은행", number: "000-000-000000" }
    ]
  },
